  ...
  function SkillPreloadPage() {
    ...
    function loadMarkdown(skill) {
      ...
      fetchJSON("/api/skills/" + encodeURIComponent(skill.name) + "/markdown")
        .then(function (payload) {
          setMarkdown(String((payload && payload.markdown) || ""));
          setSelectedSkill(Object.assign({}, skill, {
            skill_path: (payload && payload.skill_path) || skill.skill_path,
          }));
        })
        .catch(function (err) {
          setError((err && err.message) || "Failed to load skill markdown");
        })
      ...
      return React.createElement("div", { className: "skill-preload-page" },
        ...
        React.createElement(Card, { className: "skill-preload-card" },
          React.createElement(CardContent, { className: "skill-preload-card-content" },
            markdownLoading
              ? React.createElement("div", { className: "skill-preload-muted" }, "Loading markdown...")
              : React.createElement("pre", { className: "skill-markdown-pre" }, markdown)
          )
        )
      );
    }
    ...
    return React.createElement("div", { className: "skill-preload-page" },
      React.createElement("div", { className: "skill-preload-hero" },
        React.createElement("div", null,
          ...
          React.createElement("p", null,
            ...
            " means the skill can still be reached by tools. ",
            React.createElement("strong", null, "Inject"),
            " controls only whether its frontmatter/catalog entry appears in a new-session system prompt."
          )
        ),
      ...
      byCategory.map(function (entry) {
        ...
        const items = entry[1].slice().sort(function (a, b) { return String(a.name).localeCompare(String(b.name)); });
              ...
              return React.createElement("div", { key: skill.name, className: "skill-preload-row" },
                React.createElement("div", { className: "skill-preload-main" },
                  ...
                  React.createElement("button", {
                    ...
                    onClick: function () { loadMarkdown(skill); },
                ...
                React.createElement("button", {
                  ...
                  title: injected ? "Stop injecting this skill's frontmatter at startup" : "Inject this skill's frontmatter at startup",
