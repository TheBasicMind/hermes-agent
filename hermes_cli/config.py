...
OPTIONAL_ENV_VARS = {
    ...
    "TOGETHER_API_KEY": {
        "description": "Together API key for OpenClaw-derived knowledge-store embeddings",
        "prompt": "Together API key",
        "url": "https://api.together.xyz/settings/api-keys",
        "password": True,
        "tools": ["knowledge_store_write", "knowledge_store_search", "knowledge_store_maintain"],
        "category": "provider",
        "advanced": True,
    },
    "ENUMERAIT_TOKEN": {
        "description": "Bearer token for the Enumerait HTTP MCP server",
        "prompt": "Enumerait token",
        "url": None,
        "password": True,
        "category": "integration",
        "advanced": True,
    },
    # ── X/Twitter integration (all-x toolset) ──
    "AISA_API_KEY": {
        "description": "AISA API key for X/Twitter reads (all_x_read default provider)",
        "prompt": "AISA API key",
        "url": None,
        "password": True,
        "tools": ["all_x_read"],
    ...
    "XAI_API_KEY": {
        "description": "xAI/Grok API key for semantic X search (all_x_search)",
        "prompt": "xAI API key",
    ...
    "X_API_KEY": {
        "description": "Official X API key for writes (all_x_write OAuth 1.0a)",
        "prompt": "X API key (consumer key)",
    ...
    "X_API_SECRET": {
        "description": "Official X API secret for writes (all_x_write OAuth 1.0a)",
        "prompt": "X API secret (consumer secret)",
        "url": "https://developer.twitter.com/en/portal/dashboard",
        "password": True,
        "tools": ["all_x_write"],
        "category": "integration",
    ...
    "X_BEARER_TOKEN": {
        "description": "Official X Bearer Token for app-only reads (all_x_read fallback)",
    ...
    "X_ACCESS_TOKEN": {
        "description": "Official X access token for writes (all_x_write OAuth 1.0a)",
    ...
    "X_ACCESS_TOKEN_SECRET": {
        "description": "Official X access token secret for writes (all_x_write OAuth 1.0a)",
