...
def _mkdir_existing_dir_safe(path: Path) -> None:
    """Create a directory, tolerating races where an existing path becomes a dir."""
...
DEFAULT_CONFIG = {
    ...
    "skills": {
        ...
        # affect only the system-prompt catalog block; enabled skills remain
        # available through skills_list, skill_view, and skill_manage.
        "inject_catalog": True,
