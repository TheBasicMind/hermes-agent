...
CONFIGURABLE_TOOLSETS = [
    ...
    ("skills_v2",       "📚 Skills v2 (Enumerait)",     "skills_list2, skill_view2, skill_manage2"),
    ...
    ("workflow",        "🔀 Workflow Runner",           "dependency-graph workflows over cron packages: list/show/validate/run/status/logs/cancel"),
